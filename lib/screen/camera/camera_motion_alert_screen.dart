...
class _CameraMotionAlertScreenState extends State<CameraMotionAlertScreen> {
                            ...
                            onTap: () async {
                              ...
                              if(cs.cameraDetailList[0]['motionTts']!=null){
                                if(motionValue?['url'].toString()!='mute'){
                                  ...
                                  bool test =  await DeviceManager.getInstance().mDevice!.customSound!.setVoiceInfo('${config.baseUrl}/motion/${cs.cameraUID.value}','motion',1,3,playTimes: '1', playInDevice: true);
                                  bool test2 =  await DeviceManager.getInstance().mDevice!.customSound!.setVoiceInfo('${config.baseUrl}/motion/${cs.cameraUID.value}','motion',1,3,playTimes: '1',);
                                  if(test){
                                    motionValue?['url'] = '${config.baseUrl}/motion/${cs.cameraUID.value}';
                                  }
                                }
                              }
                              else {
                                if(motionValue?['url'].toString()!='mute'){
                                  ...
                                  bool test = await cs.cameraDevice!.customSound!.setVoiceInfo('${config.baseUrl}/ttsDemo', 'motion', 1, 3,playTimes: '1', playInDevice: true);
                                  bool test2 = await cs.cameraDevice!.customSound!.setVoiceInfo('${config.baseUrl}/ttsDemo', 'motion', 1, 3,playTimes: '1');
                                  if(test){
                                    motionValue?['url']= '${config.baseUrl}/motion/${cs.cameraUID.value}';
                                  }
                                }
  ...
  Future<void> oneTimeVoiceClick ()async{
    ...
    if(selectedIndex==0){
      ...
      String voiceUri = '${config.baseUrl}/motion/${cs.cameraUID.value}';
