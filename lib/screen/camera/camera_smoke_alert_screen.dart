...
class _CameraSmokeAlertScreenState extends State<CameraSmokeAlertScreen> {
                              ...
                              onTap: () async {
                                ...
                                if(cs.cameraDetailList[0]['smokeTts']!=''){
                                  if(smokeValue?['url'].toString()!='mute'){
                                    ...
                                    bool test = await cs.cameraDevice!.customSound!.setVoiceInfo('${config.apiUrl}/smoke/${cs.cameraUID.value}', 'smokes', 1, 8,playTimes: '1',playInDevice: true);
                                    bool test2 = await cs.cameraDevice!.customSound!.setVoiceInfo('${config.apiUrl}/smoke/${cs.cameraUID.value}', 'smokes', 1, 8,playTimes: '1');
                                    if(test){
                                      smokeValue?['url']= '${config.apiUrl}/smoke/${cs.cameraUID.value}';
                                    }
                                  }
                                }
                                else {
                                  if(smokeValue?['url'].toString()!='mute'){
                                    ...
                                    bool test = await cs.cameraDevice!.customSound!.setVoiceInfo('${config.apiUrl}/ttsDemo', 'smokes', 1, 8,playTimes: '1',playInDevice: true);
                                    bool test2 = await cs.cameraDevice!.customSound!.setVoiceInfo('${config.apiUrl}/ttsDemo', 'smokes', 1, 8,playTimes: '1');
                                    if(test){
                                      smokeValue?['url']= '${config.apiUrl}/smoke/${cs.cameraUID.value}';
                                    }
                                  }
  ...
  Future<void> oneTimeVoiceClick ()async{
    ...
    if(selectedIndex==0){
      ...
      String voiceUri = '${config.apiUrl}/smoke/${cs.cameraUID.value}';
