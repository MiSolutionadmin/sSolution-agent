...
class _CameraFireAlertScreenState extends State<CameraFireAlertScreen> {
                                ...
                                onTap: () async {
                                  ...
                                  if(cs.cameraDetailList[0]['fireTts']!=''){
                                    if(fireValue?['url'].toString()!='mute'){
                                      ...
                                      bool test = await cs.cameraDevice!.customSound!.setVoiceInfo('${config.apiUrl}/voice/${cs.cameraUID.value}', 'fires', 1, 7,playTimes: '1', playInDevice: true);
                                      bool test2 = await cs.cameraDevice!.customSound!.setVoiceInfo('${config.apiUrl}/voice/${cs.cameraUID.value}', 'fires', 1, 7,playTimes: '1'); // 25/1/9 추가 해야 url이 바뀜
                                      if(test){
                                        fireValue?['url']= '${config.apiUrl}/voice/${cs.cameraUID.value}';
                                      }
                                    }
                                  }
                                    ...
                                    if(fireValue?['url'].toString()!='mute'){
                                      ...
                                      bool test = await cs.cameraDevice!.customSound!.setVoiceInfo('${config.apiUrl}/ttsDemo', 'fires', 1, 7,playTimes: '1' ,playInDevice: true);
                                      bool test2 = await cs.cameraDevice!.customSound!.setVoiceInfo('${config.apiUrl}/ttsDemo', 'fires', 1, 7,playTimes: '1'); // 25/1/9 추가 해야 url이 바뀜
                                      if(test){
                                        fireValue?['url']= '${config.apiUrl}/voice/${cs.cameraUID.value}';
                                      }
                                    }
  ...
  Future<void> oneTimeVoiceClick ()async{
    ...
    if(selectedIndex==0){
      ...
      String voiceUri = '${config.apiUrl}/voice/${cs.cameraUID.value}';
