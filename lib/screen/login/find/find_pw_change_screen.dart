...
class FindPwChange extends StatefulWidget {
  ...
  const FindPwChange({super.key, required this.responseBody});

  @override
  State<FindPwChange> createState() => _FindPwChangeState();
}

class _FindPwChangeState extends State<FindPwChange> {
